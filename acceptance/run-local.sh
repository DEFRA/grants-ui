...
export AGREEMENTS_JWT_SECRET="${AGREEMENTS_JWT_SECRET:-agreements-jwt-secret}"
export AGREEMENTS_JWT_ISSUER="${AGREEMENTS_JWT_ISSUER:-grants-ui}"
export AGREEMENTS_JWT_AUDIENCE="${AGREEMENTS_JWT_AUDIENCE:-agreements-ui,gas}"
export AGREEMENTS_JWT_TTL_SEC="${AGREEMENTS_JWT_TTL_SEC:-300}"
