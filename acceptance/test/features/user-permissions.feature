Feature: User Permissions
    ...
    Scenario: Complete a grant application and claim submission with multiple users with different permissions
        ...
        And should see "Contact a person from your business to review and submit the application."
        ...
        And should see "Contact a person from your business to review and submit the claim."
