...
| `audit.entities` | `[{ entity: 'application', action: 'read', entityid: <slug> }]`                                              |
...
```text
INFO: Audit event published: messageId=4577b478-dcf9-46ba-b40f-22f9051c3798, entity=application, action=read, entityid=example-grant-with-auth
```
...
```json
{
  ...
  "ip": "192.168.65.1",
  "audit": {
    "entities": [{ "entity": "application", "action": "read", "entityid": "example-grant-with-auth" }],
    "status": "success",
