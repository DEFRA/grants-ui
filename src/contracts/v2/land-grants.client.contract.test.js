  ...
  it('returns HTTP 400 when parcel is invalid', async () => {
    ...
    await provider
      ...
      .withRequest({
        ...
        path: '/api/v2/payments/calculate',
        headers: makeLandGrantsHeaders(),
        body: withAuthenticatedSbi(badRequestPayload)
      })
      .willRespondWith({
        status: 400,
        headers: { 'Content-Type': 'application/json' },
  ...
  it('returns HTTP 422 when quantity is a string', async () => {
    ...
    await provider
      ...
      .withRequest({
        ...
        path: '/api/v2/payments/calculate',
        headers: makeLandGrantsHeaders(),
        body: withAuthenticatedSbi(invalidQuantityPayload)
      })
      .willRespondWith({
        status: 422,
        headers: { 'Content-Type': 'application/json' },
  ...
  it('returns HTTP 400 when passing a wrong field name', async () => {
    ...
    await provider
      ...
      .withRequest({
        ...
        path: '/api/v2/parcels',
        headers: makeLandGrantsHeaders(),
        body: withAuthenticatedSbi({ parcelIds: ['SD6743-8083'], fields: ['WRONG'] })
      })
  ...
  it('returns HTTP 200 and a list of parcels with size', async () => {
    ...
    await provider
      ...
      .withRequest({
        ...
        path: '/api/v2/parcels',
        headers: makeLandGrantsHeaders(),
        body: withAuthenticatedSbi({ parcelIds: ['SD6743-8083'], fields: ['size'] })
      })
  ...
  it('returns HTTP 400 when passing a wrong formatted parcel', async () => {
    ...
    await provider
      ...
      .withRequest({
        ...
        path: '/api/v2/parcels',
        headers: makeLandGrantsHeaders(),
        body: withAuthenticatedSbi({ parcelIds: ['BADFORMAT-91977'], fields: ['size'] })
      })
      .willRespondWith({ status: 400, headers: { 'Content-Type': 'application/json' }, body: EXPECTED_BODY })
      .executeTest(async (mockserver) => {
        await expect(
  ...
  it('returns HTTP 404 when parcel with size field is not found', async () => {
    ...
    await provider
      ...
      .withRequest({
        ...
        path: '/api/v2/parcels',
        headers: makeLandGrantsHeaders(),
        body: withAuthenticatedSbi({ parcelIds: ['SD6843-1234'], fields: ['size'] })
      })
  ...
  it('returns HTTP 200 and a list of parcels with actions and size', async () => {
    ...
    await provider
      ...
      .withRequest({
        ...
        path: '/api/v2/parcels',
        headers: makeLandGrantsHeaders(),
        body: withAuthenticatedSbi({ parcelIds: ['SD6743-8083'], fields: ['actions', 'size'] })
      })
      .willRespondWith({ status: 200, headers: { 'Content-Type': 'application/json' }, body: EXPECTED_BODY })
      .executeTest(async (mockserver) => {
        const response = await postToLandGrantsApi(
  ...
  it('returns HTTP 400 when parcel id is malformed', async () => {
    ...
    await provider
      ...
      .withRequest({
        ...
        path: '/api/v2/parcels',
        headers: makeLandGrantsHeaders(),
        body: withAuthenticatedSbi({ parcelIds: ['MALFORMED-PARCEL'], fields: ['actions', 'size'] })
      })
      .willRespondWith({ status: 400, headers: { 'Content-Type': 'application/json' }, body: EXPECTED_BODY })
      .executeTest(async (mockserver) => {
        await expect(
  ...
  it('returns HTTP 404 when parcel with actions and size is not found', async () => {
    ...
    await provider
      ...
      .withRequest({
        ...
        path: '/api/v2/parcels',
        headers: makeLandGrantsHeaders(),
        body: withAuthenticatedSbi({ parcelIds: ['SD1234-5678'], fields: ['actions', 'size'] })
      })
      .willRespondWith({ status: 404, headers: { 'Content-Type': 'application/json' }, body: EXPECTED_BODY })
      .executeTest(async (mockserver) => {
        await expect(
  ...
  it('returns HTTP 422 with error message when quantity is a string', async () => {
    ...
    await provider
      ...
      .withRequest({
        ...
        path: '/api/v2/application/validate',
        headers: makeLandGrantsHeaders(),
        body: withAuthenticatedSbi(negativeQuantityPayload)
      })
      .willRespondWith({
        status: 422,
        headers: { 'Content-Type': 'application/json' },
  ...
  it('returns HTTP 400 when required fields are missing', async () => {
    ...
    await provider
      ...
      .withRequest({
        ...
        path: '/api/v2/application/validate',
        headers: makeLandGrantsHeaders(),
        body: withAuthenticatedSbi(incompletePayload)
      })
      .willRespondWith({
        status: 400,
        headers: { 'Content-Type': 'application/json' },
  ...
  it('returns HTTP 400 when parcel is not found', async () => {
    ...
    await provider
      ...
      .withRequest({
        ...
        path: '/api/v2/application/validate',
        headers: makeLandGrantsHeaders(),
        body: withAuthenticatedSbi(notFoundPayload)
      })
      .willRespondWith({
        status: 400,
        headers: { 'Content-Type': 'application/json' },
