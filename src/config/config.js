...
const convictConfig = {
  ...
  maps: {
    land: {
      apiKey: {
        doc: 'Ordnance Survey Maps API key used to render land parcel geometries.',
        format: String,
        default: '',
        env: 'LAND_MAPS_API_KEY',
        sensitive: true
      },
      baseUrl: {
        ...
        env: 'LAND_MAPS_BASE_URL'
      },
      tileCacheMaxAgeSeconds: {
    ...
    forms: {
      apiKey: {
        doc: 'Ordnance Survey Maps API key used by the Defra Forms location component.',
        format: String,
        default: '',
        env: 'FORMS_MAPS_API_KEY',
        sensitive: true
      },
      apiSecret: {
        doc: 'Ordnance Survey Maps API secret used by the Defra Forms location component.',
        format: String,
        default: '',
        env: 'FORMS_MAPS_API_SECRET',
        sensitive: true
      }
    }
  },
