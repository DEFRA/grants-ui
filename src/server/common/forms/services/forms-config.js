...
export const allForms = [
  {
    path: 'src/server/common/forms/definitions/adding-value.yaml',
  ...
  {
    path: 'src/server/common/forms/definitions/adding-value/project-preparation.yaml',
    id: '30757a0e-2648-458b-9ade-030680662033',
    slug: 'project-preparation',
    title: 'Project preparation'
  },
  {
    path: 'src/server/common/forms/definitions/adding-value/facilities.yaml',
    id: '525a69d4-1064-4ae9-8ad4-07df0e7bbf64',
    slug: 'facilities',
    title: 'Facilities'
  },
  {
    path: 'src/server/common/forms/definitions/adding-value/costs.yaml',
    id: '92f595e3-b88b-41ef-b55b-1e88b0495827',
    slug: 'costs',
    title: 'Costs'
  },
  {
    path: 'src/server/common/forms/definitions/adding-value/produce-processed.yaml',
    id: '61a9c744-c2f5-4b19-8aaa-1ebce72063d3',
    slug: 'produce-processed',
    title: 'Produce'
  },
  {
    path: 'src/server/common/forms/definitions/adding-value/project-impact.yaml',
    id: '2f675a91-01c0-41bb-8558-296b5e0eafd9',
    slug: 'project-impact',
    title: 'Project'
  },
  {
    path: 'src/server/common/forms/definitions/adding-value/manual-labour-amount.yaml',
    id: '1c662c58-35ed-4975-bfb8-418acd607a34',
    slug: 'manual-labour-amount',
    title: 'Mechanisation'
  },
  {
    path: 'src/server/common/forms/definitions/adding-value/future-customers.yaml',
    id: 'b36a6415-f46f-4ac5-84ca-db0d209a6559',
    slug: 'future-customers',
    title: 'Future customers'
  },
  {
    path: 'src/server/common/forms/definitions/adding-value/collaboration.yaml',
    id: 'd2feb2b3-bf1c-4639-8108-129a2eb0ea0a',
    slug: 'collaboration',
    title: 'Collaboration'
  },
  {
    path: 'src/server/common/forms/definitions/adding-value/environmental-impact.yaml',
    id: 'd5e8404c-73fb-4721-b329-4ab604840e53',
    slug: 'environmental-impact',
    title: 'Environment'
  },
  {
    path: 'src/server/common/forms/definitions/adding-value/score-results.yaml',
    id: '240dd256-48e5-476a-aec5-492528898405',
    slug: 'score-results',
    title: 'Score results'
  },
  {
    path: 'src/server/common/forms/definitions/adding-value/business-details.yaml',
    id: 'a6d41baf-17a5-48fc-9aa2-fe5e9246fa48',
    slug: 'business-details',
    title: 'Business Details'
  },
  {
    path: 'src/server/common/forms/definitions/adding-value/who-is-applying.yaml',
    id: 'dac378f9-136b-49d1-8c58-2d4c90d7b1d1',
    slug: 'who-is-applying',
    title: 'Who is applying'
  },
  {
    path: 'src/server/common/forms/definitions/adding-value/agent-details.yaml',
    id: '21dc9fc7-15da-419a-b7fd-baa2a7500a18',
    slug: 'agent-details',
    title: 'Agent'
  },
  {
    path: 'src/server/common/forms/definitions/adding-value/applicant-details.yaml',
    id: 'f3f08612-a020-44e9-9851-9618820129ff',
    slug: 'applicant-details',
    title: 'Applicant'
  },
  {
    path: 'src/server/common/forms/definitions/adding-value/check-details.yaml',
    id: '9dd81344-0c6b-405c-b345-f7d11cfc05b6',
    slug: 'check-details',
    title: 'Check your details'
  },
  {
    path: 'src/server/common/forms/definitions/adding-value/declaration.yaml',
