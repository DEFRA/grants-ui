...
} from './gas-answers.schema.js'

describe('Adding-value schema validation -output always conforms to GAS payload schema structure', () => {
  ...
  it('should return an error if a boolean field has wrong type', () => {
    ...
    const result = validateApplicationAnswers(invalidPayload, GRANT_CODE)
