 ...
 * @param {ParcelSize|ActionData|undefined} data - The data object
...
function createUnitQuantity(data, quantityField = 'value') {
  ...
  if (quantityValue != null) {
    const quantity = Number.parseFloat(/** @type {string} */ (quantityValue))
 ...
 * @import { FormState, LandParcel, ActionData, ParcelSize } from '~/src/server/land-grants/types/form-state.d.js'
