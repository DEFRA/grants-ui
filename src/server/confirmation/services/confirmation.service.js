...
export class ConfirmationService {
   ...
   */
  static async loadConfirmationContent(form, logger) {
    if (!form?.id) {
   ...
   */
  static async hasConfigDrivenConfirmation(form, logger) {
    const confirmationContent = await this.loadConfirmationContent(form, logger)
    return !!confirmationContent
  }
}
